...
**max** [**branch**|**number**] [*\<folder\>*]
:   Print the max branch in the folder. With **branch**, prints the full
    name (e.g. `async/4`). With **number** (the default), prints the
    numeric suffix (e.g. `4`). If *folder* is omitted, infers from the
    current branch.
